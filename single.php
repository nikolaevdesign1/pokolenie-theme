...
?>
                    ...
                    <div class="journal-content">
                        <div class="journal-text-navigations">
                            <p><?php
...
?></p>
                        ...
                        <div class="journal-text-header">
                            <h1><?php the_title();?></h1>
                        </div>
                        <div class="journal-text-links">
                            <p>Автор: Поколение</p>
                            <a href="#">Поделиться</a>
                        </div>
                        ...
                        <div class="journal-universials">
							...
							<?php
  							...
  							$args = array(
    						'post_type'      => 'post',
    						'posts_per_page' => '2', // сколько выводить
  ...
  if ($news_query->have_posts()) :
    while ($news_query->have_posts()) : $news_query->the_post(); 
      ?>
                            ...
                            <a href = "<?php echo get_permalink();?>" class="journal-universial-item" target = "_blank">
