...
file_put_contents(__DIR__ . '/amo_hook_cancel.log', date('Y-m-d H:i:s') . ' - post - '. json_encode($request_post) . "\r\n", FILE_APPEND);
...
//file_put_contents(__DIR__ . '/amo_hook_cancel.log', date('Y-m-d H:i:s') . ' - user - '. json_encode($users) . "\r\n", FILE_APPEND);