...
/* Template Name: ЛК Желания и цели (новый)*/
get_header('person');
...
$user_id = get_current_user_id();
    ...
    // Санитизация
    $question_5 = sanitize_text_field($_POST['question_5']);
    $question_6 = sanitize_text_field($_POST['question_6']);
    $question_7 = sanitize_text_field($_POST['question_7']);
    ...
    $data_group['question_5'] = $question_5;
    $data_group['question_6'] = $question_6;
    $data_group['question_7'] = $question_7;

    // Сохраняем группу
    update_field('data', $data_group, 'user_' . $user_id);

    // Редирект
    wp_redirect('/заявка-твой-опыт/');
    exit;
}
  ...
  <defs>
    <clipPath id="clip0_742_959">
      <rect width="11" height="15" fill="white"/>
								...
								<a href = "/заявка-желания-и-цели"  class = "active <?php if ($done3 == '1'){echo 'done';}?>"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
  <g clip-path="url(#clip0_742_959)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.704902 5.7981H10.2963C10.4832 5.7981 10.6625 5.87526 10.7947 6.01262C10.9269 6.14997 11.0012 6.33627 11.0012 6.53052V14.2673C11.0012 14.4616 10.9269 14.6479 10.7947 14.7852C10.6625 14.9226 10.4832 14.9998 10.2963 14.9998H0.704902C0.517951 14.9998 0.338656 14.9226 0.206461 14.7852C0.0742663 14.6479 0 14.4616 0 14.2673L0 6.5293C0 6.33505 0.0742663 6.14875 0.206461 6.0114C0.338656 5.87404 0.517951 5.79688 0.704902 5.79688V5.7981Z" fill="#FFC64A"/>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.92115 10.8945L4.16103 12.9635H6.83849L6.13359 10.8627C6.41198 10.7134 6.63346 10.4705 6.76186 10.1736C6.89026 9.87671 6.918 9.54334 6.84055 9.22793C6.7631 8.91253 6.58504 8.63372 6.33543 8.43702C6.08582 8.24032 5.77941 8.13735 5.46621 8.14492C5.15302 8.15249 4.85154 8.27015 4.611 8.47869C4.37046 8.68723 4.20507 8.97434 4.14181 9.29315C4.07856 9.61195 4.12118 9.94362 4.26273 10.234C4.40427 10.5244 4.63638 10.7564 4.92115 10.892V10.8945Z" fill="#606060"/>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.81983 5.79929H8.48639V4.64939C8.49109 3.7863 8.17356 2.95494 7.60056 2.33006C7.33228 2.03041 7.00746 1.79143 6.64635 1.62802C6.28523 1.4646 5.89559 1.38027 5.50171 1.38027C5.10784 1.38027 4.71819 1.4646 4.35708 1.62802C3.99597 1.79143 3.67114 2.03041 3.40287 2.33006C2.82987 2.95494 2.51234 3.7863 2.51704 4.64939V5.79929H1.1836V4.64939C1.18172 3.4306 1.63292 2.25813 2.44302 1.37669C2.83519 0.942127 3.30895 0.595749 3.83505 0.358959C4.36114 0.12217 4.92838 0 5.50171 0C6.07504 0 6.64229 0.12217 7.16838 0.358959C7.69447 0.595749 8.16824 0.942127 8.5604 1.37669C9.37114 2.25771 9.82244 3.43045 9.81983 4.64939V5.79929Z" fill="#606060"/>
				 ...
				 <div class="personal-admin">
                   <div class="brief-container">
                        <div class="brief-header">
                            <div class = "title">Желания и цели</div>
                        </div>
					   <form class = "steps_form"  method="post">
						   ...
						   <div class = "brief-content-steps step text-counter">
							    <div class = "title">1. Почему ты хочешь попасть в группу именно к этому наставнику?</div>
								<span>Что в его пути, решениях или взглядах тебе действительно откликается?</span>
								<div class = "brief-content-steps-textarea">
								   	<textarea name="question_5" placeholder="Напишите свой ответ" id="textarea1" maxlength="2000" required><?php echo $q5?></textarea>
								 <div class = "char-count" id="char-count1">0 из 2000</div>
								</div>
						   </div>
						     <div class="brief-content-steps step">
                                <div class = "title">2. Что для тебя сейчас важнее всего из этого?</div>
                                <p>Выбери один вариант и поясни, почему.</p>
                                  <div class="custom-select-wrapper">
  									<div class="custom-select-trigger">Выберите вариант</div>
  									<div class="custom-options">
    <span class="custom-option" data-value="разобраться в себе и своих ориентирах">разобраться в себе и своих ориентирах</span>
    <span class="custom-option" data-value="получить сильное окружение">получить сильное окружение</span>
    <span class="custom-option" data-value="получить конкретные пошаговые инструкции по запуску бизнеса">получить конкретные пошаговые инструкции по запуску бизнеса</span>
    <span class="custom-option" data-value="прокачать конкретные навыки / мышление">прокачать конкретные навыки / мышление</span>
    <span class="custom-option" data-value="попробовать себя в новых форматах">попробовать себя в новых форматах</span>
    <span class="custom-option" data-value="быстро начать зарабатывать / выйти на монетизацию">быстро начать зарабатывать / выйти на монетизацию</span>
    <span class="custom-option" data-value="получить поддержку и направление от наставника">получить поддержку и направление от наставника</span>
    <span class="custom-option" data-value="найти инвестора / партнёров для проекта">найти инвестора / партнёров для проекта</span>
    <span class="custom-option" data-value="другое">другое</span>
  </div>
</div>

<input type="hidden" name="question_6" id="question_3">
								
                            </div>
						   <div class = "brief-content-steps step text-counter">
							    <div class = "title">3. Если смотреть на ближайшие 2–3 года, в каком направлении  ты хочешь двигаться?</div>
							   <span>Это может быть учёба, профессия, проекты, спорт или поиск своего пути. Опиши реальный вектор, а не идеальный образ.</span>
							<div class = "brief-content-steps-textarea">
								   	<textarea name="question_7" placeholder="Напишите свой ответ" id="textarea2" maxlength="2000" required><?php echo $q7?></textarea>
