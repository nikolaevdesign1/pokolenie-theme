<?php
/* Template Name: Новый личный кабинет */
get_header('person');
...
<circle cx="4" cy="4" r="4" fill="#FF5E17"/>
						...
						<div class = "sidebar-left-link-list <?php if ($name){echo 'done';}?>">
							<div class = "sidebar-left-link-list-item">
				 ...
				 <div class="personal-admin">
                   <div class="brief-container">
                        <div class="brief-header">
                            <div class = "title">Знакомство</div>
                        </div>
					   <div class = "welcome-screen-text">
						   <p>
							   Посмотрите видео, в котором мы рассказывам все шаги подачи анкеты.
						   </p>
							   <ul>
									<li>Что лучше указать, чтобы увеличить шансы на попадание в проект.</li>	   
									<li>На чем стоит сконцентрировать внимание.</li>	   
									<li>Для чего нам нужны эти данные.</li>	   
						   	   </ul>
							
								<video controls autoplay muted loop playsinline poster="preview.jpg">
