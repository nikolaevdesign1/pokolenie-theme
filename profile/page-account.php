...
$age_check = get_field('is_old',  'user_' . $user_id);
if($age_check == 'no'){
	
		get_template_part( 'profile/page-account_child' );
} 
                    ...
                    <div class="brief-container" style = "height:100%;">
                        ...
                        <div class="brief-contact-data">
                            ...
                            <form class = "contact-data-form" method="post" enctype="multipart/form-data">
                                ...
                                <label>
                                    <p>7. Город проживания</p>
                                    <input type="text" name="city" value = "<?php echo $city?>" required>
                                </label>
                                <div class="file-upload">
  <p>8. Фотография лицевой стороны паспорта</p>

  <!-- Скрытый input -->
								<?php
		
//$passport = get_field('паспорт', 'user_' . $user_id);

// достаём ссылку на файл, если поле заполнено
$passport_url = '';
if ($passport) {
    ...
    } elseif (filter_var($passport, FILTER_VALIDATE_URL)) {
...
<div class="file-upload-buttons">
  ...
  <input type="hidden" name="passport-file-delete" id="passport-file-delete">
