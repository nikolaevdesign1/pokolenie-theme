...
$user_id = get_current_user_id();
    ...
    // Санитизация
    $question_2 = sanitize_text_field($_POST['question_2']);
    $question_3 = sanitize_text_field($_POST['question_3']);
    $question_4 = sanitize_text_field($_POST['question_4']);
    ...
    $data_group['question_2'] = $question_2;
    $data_group['question_3'] = $question_3;
    $data_group['question_4'] = $question_4;

    // Сохраняем группу
    update_field('data', $data_group, 'user_' . $user_id);

    // Редирект
    wp_redirect('/заявка-желания-и-цели/');
    exit;
}
...
<circle cx="4" cy="4" r="4" fill="#FF5E17"/>
						...
						<div class = "sidebar-left-link-list">
							<div class = "sidebar-left-link-list-item <?php if ($name){echo 'done';}?>">
								<a href = "/контактные-данные" class = "">
  ...
  <path d="M0.382812 0.320312L5.38281 6.32031L10.3828 0.320312" stroke="#333333"/>
							...
							<div class = "sidebar_sub-list_menu">
								<a href = "/заявка-о-тебе" class = "active <?php if ($done2 == '1'){echo 'done';}?>"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
  ...
  <defs>
    <clipPath id="clip0_742_959">
      <rect width="11" height="15" fill="white"/>
								...
								<a href = "/заявка-желания-и-цели" class = "<?php if ($done3 == '1'){echo 'done';}?>">
										<svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
										  <g clip-path="url(#clip0_742_774)">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M0.704902 5.7981H10.2963C10.4832 5.7981 10.6625 5.87526 10.7947 6.01262C10.9269 6.14997 11.0012 6.33627 11.0012 6.53052V14.2673C11.0012 14.4616 10.9269 14.6479 10.7947 14.7852C10.6625 14.9226 10.4832 14.9998 10.2963 14.9998H0.704902C0.517951 14.9998 0.338656 14.9226 0.206461 14.7852C0.0742663 14.6479 0 14.4616 0 14.2673L0 6.5293C0 6.33505 0.0742663 6.14875 0.206461 6.0114C0.338656 5.87404 0.517951 5.79688 0.704902 5.79688V5.7981Z" fill="#FFC64A"/>
											<path fill-rule="evenodd" clip-rule="evenodd" d="M4.92115 10.8945L4.16103 12.9635H6.83849L6.13359 10.8627C6.41198 10.7134 6.63346 10.4705 6.76186 10.1736C6.89026 9.87671 6.918 9.54334 6.84055 9.22793C6.7631 8.91253 6.58504 8.63372 6.33543 8.43702C6.08582 8.24032 5.77941 8.13735 5.46621 8.14492C5.15302 8.15249 4.85154 8.27015 4.611 8.47869C4.37046 8.68723 4.20507 8.97434 4.14181 9.29315C4.07856 9.61195 4.12118 9.94362 4.26273 10.234C4.40427 10.5244 4.63638 10.7564 4.92115 10.892V10.8945Z" fill="#606060"/>
								...
								<a href = "/заявка-твой-опыт" class = "<?php if ($done4 == '1'){echo 'done';}?>">
										<svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
										  <g clip-path="url(#clip0_742_774)">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M0.704902 5.7981H10.2963C10.4832 5.7981 10.6625 5.87526 10.7947 6.01262C10.9269 6.14997 11.0012 6.33627 11.0012 6.53052V14.2673C11.0012 14.4616 10.9269 14.6479 10.7947 14.7852C10.6625 14.9226 10.4832 14.9998 10.2963 14.9998H0.704902C0.517951 14.9998 0.338656 14.9226 0.206461 14.7852C0.0742663 14.6479 0 14.4616 0 14.2673L0 6.5293C0 6.33505 0.0742663 6.14875 0.206461 6.0114C0.338656 5.87404 0.517951 5.79688 0.704902 5.79688V5.7981Z" fill="#FFC64A"/>
											<path fill-rule="evenodd" clip-rule="evenodd" d="M4.92115 10.8945L4.16103 12.9635H6.83849L6.13359 10.8627C6.41198 10.7134 6.63346 10.4705 6.76186 10.1736C6.89026 9.87671 6.918 9.54334 6.84055 9.22793C6.7631 8.91253 6.58504 8.63372 6.33543 8.43702C6.08582 8.24032 5.77941 8.13735 5.46621 8.14492C5.15302 8.15249 4.85154 8.27015 4.611 8.47869C4.37046 8.68723 4.20507 8.97434 4.14181 9.29315C4.07856 9.61195 4.12118 9.94362 4.26273 10.234C4.40427 10.5244 4.63638 10.7564 4.92115 10.892V10.8945Z" fill="#606060"/>
								...
								<a href = "/заявка-зоны-роста" class = " <?php if ($done5 == '1'){echo 'done';}?>">
										<svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
										  <g clip-path="url(#clip0_742_774)">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M0.704902 5.7981H10.2963C10.4832 5.7981 10.6625 5.87526 10.7947 6.01262C10.9269 6.14997 11.0012 6.33627 11.0012 6.53052V14.2673C11.0012 14.4616 10.9269 14.6479 10.7947 14.7852C10.6625 14.9226 10.4832 14.9998 10.2963 14.9998H0.704902C0.517951 14.9998 0.338656 14.9226 0.206461 14.7852C0.0742663 14.6479 0 14.4616 0 14.2673L0 6.5293C0 6.33505 0.0742663 6.14875 0.206461 6.0114C0.338656 5.87404 0.517951 5.79688 0.704902 5.79688V5.7981Z" fill="#FFC64A"/>
											<path fill-rule="evenodd" clip-rule="evenodd" d="M4.92115 10.8945L4.16103 12.9635H6.83849L6.13359 10.8627C6.41198 10.7134 6.63346 10.4705 6.76186 10.1736C6.89026 9.87671 6.918 9.54334 6.84055 9.22793C6.7631 8.91253 6.58504 8.63372 6.33543 8.43702C6.08582 8.24032 5.77941 8.13735 5.46621 8.14492C5.15302 8.15249 4.85154 8.27015 4.611 8.47869C4.37046 8.68723 4.20507 8.97434 4.14181 9.29315C4.07856 9.61195 4.12118 9.94362 4.26273 10.234C4.40427 10.5244 4.63638 10.7564 4.92115 10.892V10.8945Z" fill="#606060"/>
				 ...
				 <div class="personal-admin">
                   <div class="brief-container">
                        <div class="brief-header">
                            <div class = "title">О тебе</div>
                        </div>
					   <form class = "steps_form" method="post">
						      <?php wp_nonce_field('save_user_brief', 'user_brief_nonce'); ?>
						   <div class = "brief-content-steps step">
							    <div class = "title">1. Дата рождения</div>
							
									<input type="text" id="date" name="question_2" placeholder="дд.мм.гггг" value = "<?php echo $q2?>"  required>
									<span id="date-error" style="position: absolute; right: 10px; top: 25px; font-size: 12px; color:#C41414; display:none;">Введите корректную дату</span>
						     ...
						     <div class="brief-content-steps step">
                                ...
                                <input type="text" name="question_3" placeholder="Москва" id = "city_in" value = "<?php echo $q3?>" required>
								
							<div id = "result"></div>
								
                            </div>
						   <div class = "brief-content-steps step">
							    <div class = "title">3. Где ты сейчас учишься?</div>
							   <span>(школа / колледж / вуз / не учусь) <br> Укажи класс или курс и название учебного заведения.</span>
							
									<input type="text"  name="question_4" value = "<?php echo $q4?>" placeholder="9 класс МАОУ Лицей №176" required>
